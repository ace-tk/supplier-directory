...
export default async function NewInvoicePage({
  ...
  if (!user) redirect("/login?from=/invoices/new");
  ...
  if (source) {
    ...
    return <InvoiceEditor basePath="/invoices" type={invoiceType} initialInvoice={null} sourceInvoice={sourceInvoice} />;
  }

  const invoiceType = parseStandaloneInvoiceType(type, false);
  return <InvoiceEditor basePath="/invoices" type={invoiceType} initialInvoice={null} />;
}
