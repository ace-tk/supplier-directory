...
import { getBuyerOrders, formatMockDate, type OrderRecord } from "@/lib/mock-data";
...
export default async function BuyerOrdersPage() {
  ...
  const orders = getBuyerOrders(user?.id ?? "guest");

  return (
    <div className="space-y-6">
      <PageHeader title="Orders" description="Track orders you've placed with suppliers." />
