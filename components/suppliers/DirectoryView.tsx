...
export function DirectoryView({ initialSuppliers }: { initialSuppliers?: Supplier[] }) {
  const { suppliers, loading, createSupplier, updateSupplier, deleteSupplier } = useSuppliers(initialSuppliers);
